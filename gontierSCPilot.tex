...
Urban soundscape monitoring has only scarcely been studied by the machine listening community\~\cite{Bello:SoundAnalysisSmartCities:Chapter:18}. This work aims at contributing to this task by focusing on pleasantness as it is the most recurrent descriptor of urban soundscape quality, though similar studies could be led for other notions such as liveliness.
